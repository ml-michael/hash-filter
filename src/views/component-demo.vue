  ...
  <div :class="['max-w-3xl', 'flex flex-col', 'mx-auto py-5', 'mx-auto']">
    ...
    >
      <div class="mx-auto mb-5 flex max-w-lg flex-col gap-4">
        <span
          class="my-5 text-center text-base font-bold transition-all duration-300 dark:text-pink-400 sm:text-lg md:text-xl lg:text-2xl"
        >
          日夜切換功能，是讓小兔子的眼睛可以獲得充分的休息、減輕眼睛壓力，讓兔子們可以一直看的好遠！
        </span>
        <Btn
          text="我超喜歡 Tailwind"
          color="gray"
          class="transition-all duration-300 dark:bg-gray-600 dark:hover:bg-gray-500 dark:active:bg-gray-700"
        >
          <template v-slot:iconLeft>
            <svg
              class="h-6 w-6 fill-current text-red-500 transition-all duration-300 dark:text-pink-400"
            ...
            >
              <g>
                <path
                  d="M285.257,35.528c58.743,0.286,106.294,47.836,106.58,106.58               c0,107.624-195.918,214.204-195.918,214.204S0,248.165,0,142.108c0-58.862,47.717-106.58,106.58-106.58l0,0c36.032-0.281,69.718,17.842,89.339,48.065C215.674,53.517,249.273,35.441,285.257,35.528z"
                />
              </g>
            </svg>
          </template>
